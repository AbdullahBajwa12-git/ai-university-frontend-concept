      ...
      <Container>
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 relative min-h-[400px] flex items-center justify-center">
            {/* Background Blur */}
            <div className="absolute inset-0 bg-accent/5 rounded-full blur-[100px] -z-10" aria-hidden="true" />
            ...
            <div className="w-full max-w-md space-y-4 relative z-10">
              ...
              <div className="rec-card opacity-0 p-5 bg-bg-surface border border-border-subtle rounded-xl flex items-center justify-between group hover:border-border-focus transition-colors">
                ...
                <div className="h-8 w-8 rounded-full border border-border-subtle flex items-center justify-center group-hover:bg-accent/10 transition-colors">
